...
CMD ["sh", "-c", "echo '⏳ Waiting for database...' && until nc -z db 5432; do sleep 2; done && echo '✅ DB ready, running migrations...' && npx prisma generate && npx prisma migrate deploy && echo '🚀 Starting app...' && yarn start"]
