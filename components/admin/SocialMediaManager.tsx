...
export default function SocialMediaManager({ onBack }: SocialMediaManagerProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-slate-100">{link.platform}</h3>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Footer Preview</h2>
          <p className="text-sm text-gray-600 dark:text-slate-400">
